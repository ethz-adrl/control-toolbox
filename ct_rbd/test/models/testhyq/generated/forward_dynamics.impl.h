/*! \file
 *	\brief		Implementation of Forward Dynamics
 *  \author	    Michael Neunert
 *
 *  Since iit::HyQ::ForwardDynamics has become a templated class, we have to put its implementation in a header. This is said header.
 */
    ...
    const ExtForces& fext/* = zeroExtForces */)
{
    ...
    trunk_a = - TRAIT::solve(trunk_AI, trunk_p );
