...
class ADCodegenLinearizer : public LinearSystem<MANIFOLD, CONTROL_DIM, CONT_T>
{
public:
    ...
    typedef DynamicsLinearizerADCG<MANIFOLD, MANIFOLD_AD, CONTROL_DIM, CONT_T>
	 ...
	 */
    ADCodegenLinearizer(std::shared_ptr<AD_System_t> nonlinearSystem, bool cacheJac = true)
    ...
    //! copy constructor
    ADCodegenLinearizer(const ADCodegenLinearizer<MANIFOLD, MANIFOLD_AD, CONTROL_DIM, CONT_T>& arg)
    ...
    //! deep cloning
    ADCodegenLinearizer<MANIFOLD, MANIFOLD_AD, CONTROL_DIM, CONT_T>* clone() const override
    {
        return new ADCodegenLinearizer<MANIFOLD, MANIFOLD_AD, CONTROL_DIM, CONT_T>(*this);
    }
	 ...
	 */
    const state_matrix_t& getDerivativeState(const MANIFOLD& x,
