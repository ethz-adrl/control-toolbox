...
class SecondOrderSystem : public ControlledSystem<EuclideanState<2>, 1, SCALAR>
{
public:
    ...
    using Controller_t = Controller<StateVector_t, CONTROL_DIM, SCALAR>;
    using Base = ControlledSystem<StateVector_t, CONTROL_DIM, SCALAR>;
