...
#ifndef INCLUDE_CORE_INTERNAL_TRAITS_DOUBLETRAIT_HPP_
#define INCLUDE_CORE_INTERNAL_TRAITS_DOUBLETRAIT_HPP_
...
#endif /* INCLUDE_EXTERNAL_HYQ_TRAITS_DOUBLETRAIT_HPP_ */
