...
using ControlTrajectory = DiscreteTrajectory<ControlVector<CONTROL_DIM, SCALAR>,
    Eigen::aligned_allocator<ControlVector<CONTROL_DIM, SCALAR>>>;

template <size_t CONTROL_DIM, typename SCALAR = double>
using ControlMatrixTrajectory = DiscreteTrajectory<ControlMatrix<CONTROL_DIM, SCALAR>>;
...
template <size_t STATE_DIM, size_t CONTROL_DIM, typename SCALAR = double>
using StateControlMatrixTrajectory = DiscreteTrajectory<StateControlMatrix<STATE_DIM, CONTROL_DIM, SCALAR>>;
