...
#ifndef EXAMPLES_CUSTOMCONTROLLER_H_
#define EXAMPLES_CUSTOMCONTROLLER_H_
...
public:
	...
	// default constructor
	CustomController(
		const ct::core::ControlVector<control_dim>& uff, // feedforward control
...
#endif /* EXAMPLES_CUSTOMCONTROLLER_H_ */
