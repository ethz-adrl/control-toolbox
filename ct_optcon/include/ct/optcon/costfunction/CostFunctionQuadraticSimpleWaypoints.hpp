...
class CostFunctionQuadraticSimpleWaypoints : public CostFunctionQuadratic<MANIFOLD, CONTROL_DIM>
{
public:
    ...
    CostFunctionQuadraticSimpleWaypoints() = delete;
    /**
     ...
     */
    CostFunctionQuadraticSimpleWaypoints(const state_matrix_t& Q,
    ...
    CostFunctionQuadraticSimpleWaypoints(const CostFunctionQuadraticSimpleWaypoints& arg);

    /**
     * Clones the cost function.
     * @return
     */
    CostFunctionQuadraticSimpleWaypoints<MANIFOLD, CONTROL_DIM>* clone() const override;
...
protected:
    ...
    std::vector<MANIFOLD> x_nominal_;
    state_matrix_t Q_;
    ...
    std::vector<control_vector_t> u_nominal_;
    control_matrix_t R_;
