#ifndef DERIVATIVES_VECTORIZED_DERIVATIVES_FULL_PWL_HPP_
#define DERIVATIVES_VECTORIZED_DERIVATIVES_FULL_PWL_HPP_
...
// TODO: ISSUE FIXME: this could be nicely summarize in a class templated on <size_t OPT_TIME_GRID, ....>
