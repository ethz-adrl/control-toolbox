...
namespace tpl {
    ...
    public:
        ...
        TestTimeParameterizedLinearSystem(state_matrix_t& A, state_control_matrix_t& B, std::shared_ptr<Controller<3, 2, SCALAR>> controller = nullptr)
    ...
    public:
        ...
        // constructor directly using A and B
        TestDiscreteLinearSystem(state_matrix_t A, state_control_matrix_t B, std::shared_ptr<DiscreteController<2, 1, SCALAR>> controller = nullptr)
        : Base(controller, SYSTEM_TYPE::GENERAL), A_(A), B_(B)
            {
            }
