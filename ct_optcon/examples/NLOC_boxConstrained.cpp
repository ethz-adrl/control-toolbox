...
int main(int argc, char **argv)
{
    ...
    ilqr_settings.lqocp_solver = NLOptConSettings::LQOCP_SOLVER::
        HPIPM_SOLVER;  // the LQ-problems are solved using HPIPM
    ...
    // let's examine the output. Here, we print the optimized feedforward trajectory.
    solution.getFeedforwardTrajectory().print();
}
