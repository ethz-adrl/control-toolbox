...
class JSIM : public iit::rbd::StateDependentMatrix<iit::HyQ::JointState, 18, 18, JSIM<TRAIT>>
{
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    private:
        typedef iit::rbd::StateDependentMatrix<iit::HyQ::JointState, 18, 18, JSIM<TRAIT>> Base;
    public:
