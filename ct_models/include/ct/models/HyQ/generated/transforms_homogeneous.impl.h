...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LF_hipassembly& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LF_hipassembly::update(const JointState& q) {
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RF_hipassembly& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RF_hipassembly::update(const JointState& q) {
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LH_hipassembly& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LH_hipassembly::update(const JointState& q) {
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RH_hipassembly& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RH_hipassembly::update(const JointState& q) {
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LF_upperleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LF_upperleg::update(const JointState& q) {
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RF_upperleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RF_upperleg::update(const JointState& q) {
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LH_upperleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LH_upperleg::update(const JointState& q) {
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RH_upperleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RH_upperleg::update(const JointState& q) {
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LF_lowerleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LF_lowerleg::update(const JointState& q) {
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RF_lowerleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RF_lowerleg::update(const JointState& q) {
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LH_lowerleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LH_lowerleg::update(const JointState& q) {
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RH_lowerleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RH_lowerleg::update(const JointState& q) {
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LF_hipassembly_X_fr_trunk& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LF_hipassembly_X_fr_trunk::update(const JointState& q) {
    SCALAR sin__q_LF_HAA__;
    SCALAR cos__q_LF_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RF_hipassembly_X_fr_trunk& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RF_hipassembly_X_fr_trunk::update(const JointState& q) {
    SCALAR sin__q_RF_HAA__;
    SCALAR cos__q_RF_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LH_hipassembly_X_fr_trunk& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LH_hipassembly_X_fr_trunk::update(const JointState& q) {
    SCALAR sin__q_LH_HAA__;
    SCALAR cos__q_LH_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RH_hipassembly_X_fr_trunk& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RH_hipassembly_X_fr_trunk::update(const JointState& q) {
    SCALAR sin__q_RH_HAA__;
    SCALAR cos__q_RH_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LF_upperleg_X_fr_trunk& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LF_upperleg_X_fr_trunk::update(const JointState& q) {
    SCALAR sin__q_LF_HFE__;
    SCALAR sin__q_LF_HAA__;
    SCALAR cos__q_LF_HFE__;
    SCALAR cos__q_LF_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RF_upperleg_X_fr_trunk& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RF_upperleg_X_fr_trunk::update(const JointState& q) {
    SCALAR sin__q_RF_HFE__;
    SCALAR sin__q_RF_HAA__;
    SCALAR cos__q_RF_HFE__;
    SCALAR cos__q_RF_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LH_upperleg_X_fr_trunk& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LH_upperleg_X_fr_trunk::update(const JointState& q) {
    SCALAR sin__q_LH_HFE__;
    SCALAR sin__q_LH_HAA__;
    SCALAR cos__q_LH_HFE__;
    SCALAR cos__q_LH_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RH_upperleg_X_fr_trunk& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RH_upperleg_X_fr_trunk::update(const JointState& q) {
    SCALAR sin__q_RH_HFE__;
    SCALAR sin__q_RH_HAA__;
    SCALAR cos__q_RH_HFE__;
    SCALAR cos__q_RH_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LF_lowerleg_X_fr_trunk& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LF_lowerleg_X_fr_trunk::update(const JointState& q) {
    SCALAR sin__q_LF_KFE__;
    SCALAR sin__q_LF_HFE__;
    SCALAR sin__q_LF_HAA__;
    SCALAR cos__q_LF_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RF_lowerleg_X_fr_trunk& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RF_lowerleg_X_fr_trunk::update(const JointState& q) {
    SCALAR sin__q_RF_KFE__;
    SCALAR sin__q_RF_HFE__;
    SCALAR sin__q_RF_HAA__;
    SCALAR cos__q_RF_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LH_lowerleg_X_fr_trunk& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LH_lowerleg_X_fr_trunk::update(const JointState& q) {
    SCALAR sin__q_LH_KFE__;
    SCALAR sin__q_LH_HFE__;
    SCALAR sin__q_LH_HAA__;
    SCALAR cos__q_LH_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RH_lowerleg_X_fr_trunk& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RH_lowerleg_X_fr_trunk::update(const JointState& q) {
    SCALAR sin__q_RH_KFE__;
    SCALAR sin__q_RH_HFE__;
    SCALAR sin__q_RH_HAA__;
    SCALAR cos__q_RH_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_LF_hipassemblyCOM& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_LF_hipassemblyCOM::update(const JointState& q) {
    SCALAR sin__q_LF_HAA__;
    SCALAR cos__q_LF_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_RF_hipassemblyCOM& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_RF_hipassemblyCOM::update(const JointState& q) {
    SCALAR sin__q_RF_HAA__;
    SCALAR cos__q_RF_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_LH_hipassemblyCOM& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_LH_hipassemblyCOM::update(const JointState& q) {
    SCALAR sin__q_LH_HAA__;
    SCALAR cos__q_LH_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_RH_hipassemblyCOM& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_RH_hipassemblyCOM::update(const JointState& q) {
    SCALAR sin__q_RH_HAA__;
    SCALAR cos__q_RH_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_LF_upperlegCOM& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_LF_upperlegCOM::update(const JointState& q) {
    SCALAR sin__q_LF_HFE__;
    SCALAR sin__q_LF_HAA__;
    SCALAR cos__q_LF_HFE__;
    SCALAR cos__q_LF_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_RF_upperlegCOM& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_RF_upperlegCOM::update(const JointState& q) {
    SCALAR sin__q_RF_HFE__;
    SCALAR sin__q_RF_HAA__;
    SCALAR cos__q_RF_HFE__;
    SCALAR cos__q_RF_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_LH_upperlegCOM& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_LH_upperlegCOM::update(const JointState& q) {
    SCALAR sin__q_LH_HFE__;
    SCALAR sin__q_LH_HAA__;
    SCALAR cos__q_LH_HFE__;
    SCALAR cos__q_LH_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_RH_upperlegCOM& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_RH_upperlegCOM::update(const JointState& q) {
    SCALAR sin__q_RH_HFE__;
    SCALAR sin__q_RH_HAA__;
    SCALAR cos__q_RH_HFE__;
    SCALAR cos__q_RH_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_LF_lowerlegCOM& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_LF_lowerlegCOM::update(const JointState& q) {
    SCALAR sin__q_LF_KFE__;
    SCALAR sin__q_LF_HFE__;
    SCALAR sin__q_LF_HAA__;
    SCALAR cos__q_LF_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_RF_lowerlegCOM& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_RF_lowerlegCOM::update(const JointState& q) {
    SCALAR sin__q_RF_KFE__;
    SCALAR sin__q_RF_HFE__;
    SCALAR sin__q_RF_HAA__;
    SCALAR cos__q_RF_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_LH_lowerlegCOM& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_LH_lowerlegCOM::update(const JointState& q) {
    SCALAR sin__q_LH_KFE__;
    SCALAR sin__q_LH_HFE__;
    SCALAR sin__q_LH_HAA__;
    SCALAR cos__q_LH_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_RH_lowerlegCOM& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_RH_lowerlegCOM::update(const JointState& q) {
    SCALAR sin__q_RH_KFE__;
    SCALAR sin__q_RH_HFE__;
    SCALAR sin__q_RH_HAA__;
    SCALAR cos__q_RH_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LF_foot_X_fr_LF_lowerleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LF_foot_X_fr_LF_lowerleg::update(const JointState& q) {
    return *this;
}
template <typename TRAIT>
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RF_foot_X_fr_RF_lowerleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RF_foot_X_fr_RF_lowerleg::update(const JointState& q) {
    return *this;
}
template <typename TRAIT>
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LH_foot_X_fr_LH_lowerleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LH_foot_X_fr_LH_lowerleg::update(const JointState& q) {
    return *this;
}
template <typename TRAIT>
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RH_foot_X_fr_RH_lowerleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RH_foot_X_fr_RH_lowerleg::update(const JointState& q) {
    return *this;
}
template <typename TRAIT>
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LF_foot& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LF_foot::update(const JointState& q) {
    SCALAR sin__q_LF_KFE__;
    SCALAR sin__q_LF_HFE__;
    SCALAR sin__q_LF_HAA__;
    SCALAR cos__q_LF_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RF_foot& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RF_foot::update(const JointState& q) {
    SCALAR sin__q_RF_KFE__;
    SCALAR sin__q_RF_HFE__;
    SCALAR sin__q_RF_HAA__;
    SCALAR cos__q_RF_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LH_foot& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LH_foot::update(const JointState& q) {
    SCALAR sin__q_LH_KFE__;
    SCALAR sin__q_LH_HFE__;
    SCALAR sin__q_LH_HAA__;
    SCALAR cos__q_LH_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RH_foot& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RH_foot::update(const JointState& q) {
    SCALAR sin__q_RH_KFE__;
    SCALAR sin__q_RH_HFE__;
    SCALAR sin__q_RH_HAA__;
    SCALAR cos__q_RH_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LF_foot_X_fr_trunk& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LF_foot_X_fr_trunk::update(const JointState& q) {
    SCALAR sin__q_LF_KFE__;
    SCALAR sin__q_LF_HFE__;
    SCALAR sin__q_LF_HAA__;
    SCALAR cos__q_LF_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RF_foot_X_fr_trunk& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RF_foot_X_fr_trunk::update(const JointState& q) {
    SCALAR sin__q_RF_KFE__;
    SCALAR sin__q_RF_HFE__;
    SCALAR sin__q_RF_HAA__;
    SCALAR cos__q_RF_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LH_foot_X_fr_trunk& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LH_foot_X_fr_trunk::update(const JointState& q) {
    SCALAR sin__q_LH_KFE__;
    SCALAR sin__q_LH_HFE__;
    SCALAR sin__q_LH_HAA__;
    SCALAR cos__q_LH_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RH_foot_X_fr_trunk& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RH_foot_X_fr_trunk::update(const JointState& q) {
    SCALAR sin__q_RH_KFE__;
    SCALAR sin__q_RH_HFE__;
    SCALAR sin__q_RH_HAA__;
    SCALAR cos__q_RH_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LF_HAA& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LF_HAA::update(const JointState& q) {
    return *this;
}
template <typename TRAIT>
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RF_HAA& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RF_HAA::update(const JointState& q) {
    return *this;
}
template <typename TRAIT>
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LH_HAA& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LH_HAA::update(const JointState& q) {
    return *this;
}
template <typename TRAIT>
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RH_HAA& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RH_HAA::update(const JointState& q) {
    return *this;
}
template <typename TRAIT>
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LF_HFE& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LF_HFE::update(const JointState& q) {
    SCALAR sin__q_LF_HAA__;
    SCALAR cos__q_LF_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RF_HFE& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RF_HFE::update(const JointState& q) {
    SCALAR sin__q_RF_HAA__;
    SCALAR cos__q_RF_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LH_HFE& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LH_HFE::update(const JointState& q) {
    SCALAR sin__q_LH_HAA__;
    SCALAR cos__q_LH_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RH_HFE& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RH_HFE::update(const JointState& q) {
    SCALAR sin__q_RH_HAA__;
    SCALAR cos__q_RH_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LF_KFE& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LF_KFE::update(const JointState& q) {
    SCALAR sin__q_LF_HFE__;
    SCALAR sin__q_LF_HAA__;
    SCALAR cos__q_LF_HFE__;
    SCALAR cos__q_LF_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RF_KFE& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RF_KFE::update(const JointState& q) {
    SCALAR sin__q_RF_HFE__;
    SCALAR sin__q_RF_HAA__;
    SCALAR cos__q_RF_HFE__;
    SCALAR cos__q_RF_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LH_KFE& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_LH_KFE::update(const JointState& q) {
    SCALAR sin__q_LH_HFE__;
    SCALAR sin__q_LH_HAA__;
    SCALAR cos__q_LH_HFE__;
    SCALAR cos__q_LH_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RH_KFE& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_trunk_X_fr_RH_KFE::update(const JointState& q) {
    SCALAR sin__q_RH_HFE__;
    SCALAR sin__q_RH_HAA__;
    SCALAR cos__q_RH_HFE__;
    SCALAR cos__q_RH_HAA__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LF_upperleg_X_fr_LF_hipassembly& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LF_upperleg_X_fr_LF_hipassembly::update(const JointState& q) {
    SCALAR sin__q_LF_HFE__;
    SCALAR cos__q_LF_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LF_hipassembly_X_fr_LF_upperleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LF_hipassembly_X_fr_LF_upperleg::update(const JointState& q) {
    SCALAR sin__q_LF_HFE__;
    SCALAR cos__q_LF_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LF_lowerleg_X_fr_LF_upperleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LF_lowerleg_X_fr_LF_upperleg::update(const JointState& q) {
    SCALAR sin__q_LF_KFE__;
    SCALAR cos__q_LF_KFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LF_upperleg_X_fr_LF_lowerleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LF_upperleg_X_fr_LF_lowerleg::update(const JointState& q) {
    SCALAR sin__q_LF_KFE__;
    SCALAR cos__q_LF_KFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RF_upperleg_X_fr_RF_hipassembly& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RF_upperleg_X_fr_RF_hipassembly::update(const JointState& q) {
    SCALAR sin__q_RF_HFE__;
    SCALAR cos__q_RF_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RF_hipassembly_X_fr_RF_upperleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RF_hipassembly_X_fr_RF_upperleg::update(const JointState& q) {
    SCALAR sin__q_RF_HFE__;
    SCALAR cos__q_RF_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RF_lowerleg_X_fr_RF_upperleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RF_lowerleg_X_fr_RF_upperleg::update(const JointState& q) {
    SCALAR sin__q_RF_KFE__;
    SCALAR cos__q_RF_KFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RF_upperleg_X_fr_RF_lowerleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RF_upperleg_X_fr_RF_lowerleg::update(const JointState& q) {
    SCALAR sin__q_RF_KFE__;
    SCALAR cos__q_RF_KFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LH_upperleg_X_fr_LH_hipassembly& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LH_upperleg_X_fr_LH_hipassembly::update(const JointState& q) {
    SCALAR sin__q_LH_HFE__;
    SCALAR cos__q_LH_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LH_hipassembly_X_fr_LH_upperleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LH_hipassembly_X_fr_LH_upperleg::update(const JointState& q) {
    SCALAR sin__q_LH_HFE__;
    SCALAR cos__q_LH_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LH_lowerleg_X_fr_LH_upperleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LH_lowerleg_X_fr_LH_upperleg::update(const JointState& q) {
    SCALAR sin__q_LH_KFE__;
    SCALAR cos__q_LH_KFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LH_upperleg_X_fr_LH_lowerleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_LH_upperleg_X_fr_LH_lowerleg::update(const JointState& q) {
    SCALAR sin__q_LH_KFE__;
    SCALAR cos__q_LH_KFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RH_upperleg_X_fr_RH_hipassembly& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RH_upperleg_X_fr_RH_hipassembly::update(const JointState& q) {
    SCALAR sin__q_RH_HFE__;
    SCALAR cos__q_RH_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RH_hipassembly_X_fr_RH_upperleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RH_hipassembly_X_fr_RH_upperleg::update(const JointState& q) {
    SCALAR sin__q_RH_HFE__;
    SCALAR cos__q_RH_HFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RH_lowerleg_X_fr_RH_upperleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RH_lowerleg_X_fr_RH_upperleg::update(const JointState& q) {
    SCALAR sin__q_RH_KFE__;
    SCALAR cos__q_RH_KFE__;
...
template <typename TRAIT>
const typename iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RH_upperleg_X_fr_RH_lowerleg& iit::HyQ::tpl::HomogeneousTransforms<TRAIT>::Type_fr_RH_upperleg_X_fr_RH_lowerleg::update(const JointState& q) {
    SCALAR sin__q_RH_KFE__;
    SCALAR cos__q_RH_KFE__;
